...
function createScene() {
  ...
  HEIGHT = document.querySelector('.helicopter_3d').offsetHeight;
  WIDTH = document.querySelector('.helicopter_3d').offsetWidth;
  ...
  container = document.querySelector('.helicopter_3d #world');
